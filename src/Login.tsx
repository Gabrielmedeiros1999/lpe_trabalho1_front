                        ...
                        <form className="space-y-4 md:space-y-6" 
                           onSubmit={handleSubmit(verificaLogin)} >
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm font-medium text-cyan-600 hover:underline dark:text-cyan-500">Esqueceu sua senha?</a>
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Ainda não possui conta? <Link to="/cadCliente" className="font-medium text-green-600 hover:underline dark:text-green-500">Cadastre-se</Link>
                            </p>
                        </form>
                    </div>
                </div>
