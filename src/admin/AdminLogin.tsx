...
export default function AdminLogin() {
  ...
  return (
    <main className="bg-slate-800 min-h-screen flex flex-col items-center justify-center text-white">
      <img src="../../jogo.png" alt="Revenda" style={{ width: 240 }}
        className="d-block" />
      <div className="max-w-sm">
        <h1 className="text-3xl font-bold my-8">Admin: Revenda Jogos</h1>
